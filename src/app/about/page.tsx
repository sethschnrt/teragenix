...
const workflowCards = [
  {
    ...
    body: "Move from research goal to product faster by narrowing the catalog before comparing individual peptides.",
  },
  {
    icon: Package,
    title: "See the product upfront",
    body: "Each listing shows the compound, specs, and documentation context together, so you know exactly what you are evaluating faster.",
  },
  {
    icon: ScanSearch,
    title: "Verify details sooner",
    body: "Specs, pricing, product contents, and storage guidance stay visible without digging through filler copy.",
  },
];
...
const principleCards = [
  ...
  },
  {
    ...
    body: "Products should feel clear from the first glance, without extra bundled positioning muddying the offer.",
  },
  {
    icon: Microscope,
...
const qualityPoints = [
  ...
  "Product contents shown before checkout",
  ...
  return (
    <main>
      <PageHero
        ...
        detail="Premium peptides and supporting proof"
        title="What better peptides make possible."
        description="Teragenix is built around premium peptides for specific outcomes and the proof serious buyers expect to see."
        variant="subpage"
        panelEyebrow="BUYER SYSTEM"
        panelTitle="What makes Teragenix different."
        panelItems={[
          { label: "Premium peptides", value: "Built for outcomes" },
          { label: "Standalone products", value: "Peptide-first detail" },
          ...
          <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-6">
            <div className="rounded-[2rem] bg-white p-7 ring-1 ring-[#e3e8ef] sm:p-8">
              ...
              <div className="mt-5 space-y-4 text-[15px] leading-7 text-[#475967] sm:text-[16px]">
                <p>
                  The core promise is simple: better peptides and clearer proof behind the purchase.
                </p>
                <p>
                  Instead of hiding the peptide behind vague positioning, Teragenix frames each product around the outcome, the peptide, and the supporting details that justify it.
                </p>
                <p>
          ...
          <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="rounded-[2rem] bg-white p-7 ring-1 ring-[#e3e8ef] sm:p-8">
              ...
              <h2 className="mt-3 text-[1.9rem] font-semibold leading-tight tracking-[-0.03em] text-[#0d262d] sm:text-[2.35rem]">
                Start with the category, then verify the product.
              </h2>
              <div className="mt-6 space-y-4">
                {[
                  "Browse by category first so you can narrow down the right peptides faster.",
                  "Use the product page to confirm the product contents, specs, and storage guidance.",
