...
export function ShopPageClient() {
  ...
  const initialCategory = useMemo<ShopCategory>(
    () => normalizeCategoryParam(searchParams.get("category")) ?? "All",
    [searchParams],
  );
        ...
        <div className="relative mx-auto max-w-[1240px] px-5 pb-5 sm:px-8 sm:pb-6 lg:px-12">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 max-w-xl text-[0.96rem] leading-6 text-white/72">
              Shop peptides for fat loss, recovery, longevity, and aesthetics, with visible specs, cleaner product pages, and supporting proof.
            </p>
          </div>
        </div>
      </section>
                ...
                <div className="flex flex-col flex-1 gap-2.5 px-5 pb-5 pt-4">
                  ...
                  <div className="flex items-end justify-between gap-3 pt-3">
                    <div className="min-w-0">
                      <span className="block pt-0.5 font-sans text-[1.18rem] font-semibold leading-[1.28] tracking-[-0.01em] text-foreground sm:text-[1.38rem]">
                        ${product.price}
                      </span>
